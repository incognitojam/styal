...
>()("@styal/cli/relay/AgentAwarenessRelay") {}
      ...
      switch (startupState) {
        case "waiting-for-link":
          yield* Effect.logInfo(
            "agent activity publishing standby; waiting for styal Link reconciliation",
          );
          break;
        case "disabled":
          yield* Effect.logInfo("agent activity publishing disabled by styal Link configuration");
          break;
        case "enabled":
