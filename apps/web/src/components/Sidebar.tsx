...
// The v2 suffix identifies the settled-shelf preference model.
const SETTLED_SHELF_EXPANDED_KEY = "styal:sidebar-v2:settled-expanded";
const SNOOZED_SHELF_EXPANDED_KEY = "styal:sidebar-v2:snoozed-expanded";
...
const SidebarDraftRow = memo(function SidebarDraftRow(props: {
  ...
  const attachmentCount =
    Math.max(
      ...
      composer.persistedAttachments.filter((attachment) => attachment.type !== "file").length,
    ) +
...
const SidebarThreadRow = memo(function SidebarThreadRow(props: {
  ...
  const settledPrHoverClass = pr ? settledPrHoverColorClass(pr) : undefined;
  useEffect(() => {
...
export default function Sidebar() {
  ...
  // Threads on non-primary environments (styal Link, hosted) resolve their
