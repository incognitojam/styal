...
styal remembers the last provider, model, and model options you selected and reuses that
...
and attachments. styal deletes the local audio file after transcription or cancellation. It sends
