    ...
    >
      <DialogPopup className="max-w-md" showCloseButton={isConfirming}>
        <DialogHeader>
          ...
          <DialogDescription>
            {isInstalling
              ? "T3 Code is preparing this environment for secure access through styal Connect."
              : "T3 Code needs the relay client to make this environment available through styal Connect."}
          </DialogDescription>
        </DialogHeader>
