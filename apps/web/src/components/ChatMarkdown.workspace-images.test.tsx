...
// Every atom reads as a pending query; the server config fields it also stands in for report no
// pull request support, so links around images render as plain anchors.
