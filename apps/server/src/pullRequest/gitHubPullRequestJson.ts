...
const RawDetailSchema = Schema.Struct({
  ...
  /** The standing instruction and strategy GitHub will use once requirements are met. */
...
function toAutoMergeMethod(value: string | null | undefined): PullRequestMergeMethod | undefined {
  switch (value?.trim().toUpperCase()) {
    case "MERGE":
      return "merge";
    case "SQUASH":
