                  ...
                  {row.live ? (
                    ...
                    <>
                      ...
                      >
                        ...
                        {fileChangeStat ? (
                          <Text>
                            <Text className="font-t3-medium text-adaptive-emerald-600-400">{` +${fileChangeStat.additions}`}</Text>
                            <Text className="font-t3-medium text-danger-foreground">{` -${fileChangeStat.deletions}`}</Text>
                          </Text>
                        ) : null}
                      </Text>
                    </>
