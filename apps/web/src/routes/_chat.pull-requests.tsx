  ...
  const searchInput = (
    <PullRequestSearchInput
      ...
      onChange={(query) => {
        ...
        updateListScope({ q: query || undefined });
      }}
    />
  );
    ...
    <>
      {!capabilityKnown ? (
        ...
        <PullRequestsUnavailableState
          ...
          error="Update your styal servers to browse pull requests."
        />
      ) : firstLoad ? (
        <PullRequestListGhost rows={7} />
  ...
  return (
    ...
    <div className="@container/pr-list flex min-h-0 min-w-0 flex-1 flex-col bg-background">
      ...
      >
        ...
        {condensed ? (
          <div ref={topbarSearchContainerRef} className="flex shrink items-center gap-1.5">
            <ExpandableSearch
