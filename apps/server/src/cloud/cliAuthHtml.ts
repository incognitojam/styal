...
<html lang="en">
  <head>
    ...
    <title>styal Link authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up styal Link. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
