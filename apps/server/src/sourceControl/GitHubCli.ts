...
export class GitHubIssueListDecodeError extends Schema.TaggedError<GitHubIssueListDecodeError>()(
...
export class GitHubReferenceDecodeError extends Schema.TaggedError<GitHubReferenceDecodeError>()(
