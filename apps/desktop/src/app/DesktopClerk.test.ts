...
describe("DesktopClerk", () => {
  ...
  it.effect("acquires and releases the SDK bridge with the layer", () => {
    ...
    return Effect.gen(function* () {
        ...
        [
          {
            ...
            passkeys: true,
            renderer: { scheme: "styal-dev", host: "app" },
          },
        ],
      ]);
      ...
      assert.deepEqual(events, ["setPath:userData:/tmp/app-data/styal-dev", "createClerkBridge"]);
  ...
  it.each([
    { isDevelopment: true, scheme: "styal-dev" },
    { isDevelopment: false, scheme: "styal" },
