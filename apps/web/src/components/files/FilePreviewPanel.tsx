...
const FILE_EXPLORER_STORAGE_KEY = "styal.fileExplorerOpen";
const RENDER_MARKDOWN_STORAGE_KEY = "styal.renderMarkdown";
const RENDER_BROWSER_FILE_STORAGE_KEY = "styal.renderBrowserFile";
