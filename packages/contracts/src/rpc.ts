...
import {
  ...
  SourceControlResolveReferencesInput,
  SourceControlResolveReferencesResult,
  SourceControlIssue,
  SourceControlListIssuesInput,
  SourceControlListIssuesResult,
...
export const WS_METHODS = {
  ...
  terminalClosePreflight: "terminal.closePreflight",
...
const WsSubscribeComposerDraftRpc = Rpc.make(WS_METHODS.subscribeComposerDraft, {
...
const WsServerPreviewLegacyImportRpc = Rpc.make(WS_METHODS.serverPreviewLegacyImport, {
  payload: Schema.Struct({}),
  success: LegacyImportPreview,
  error: EnvironmentAuthorizationError,
});

const WsServerImportLegacyDataRpc = Rpc.make(WS_METHODS.serverImportLegacyData, {
...
const WsSourceControlGetDefaultRepositoryRpc = Rpc.make(
...
const WsSourceControlSetDefaultRepositoryRpc = Rpc.make(
...
const WsSourceControlListIssuesRpc = Rpc.make(WS_METHODS.sourceControlListIssues, {
  payload: SourceControlListIssuesInput,
  success: SourceControlListIssuesResult,
  error: Schema.Union([SourceControlProviderError, EnvironmentAuthorizationError]),
});

const WsSourceControlGetIssueRpc = Rpc.make(WS_METHODS.sourceControlGetIssue, {
  payload: SourceControlGetIssueInput,
  success: SourceControlIssue,
  error: Schema.Union([SourceControlProviderError, EnvironmentAuthorizationError]),
});

const WsSourceControlResolveReferencesRpc = Rpc.make(WS_METHODS.sourceControlResolveReferences, {
  payload: SourceControlResolveReferencesInput,
  success: SourceControlResolveReferencesResult,
  error: Schema.Union([SourceControlProviderError, EnvironmentAuthorizationError]),
});
...
const WsTerminalClosePreflightRpc = Rpc.make(WS_METHODS.terminalClosePreflight, {
  payload: TerminalClosePreflightInput,
  success: TerminalClosePreflightResult,
  error: Schema.Union([TerminalError, EnvironmentAuthorizationError]),
});
...
const WsOrchestrationGetCommandOutputRpc = Rpc.make(ORCHESTRATION_WS_METHODS.getCommandOutput, {
  payload: OrchestrationGetCommandOutputInput,
  success: OrchestrationRpcSchemas.getCommandOutput.output,
  error: Schema.Union([OrchestrationGetCommandOutputError, EnvironmentAuthorizationError]),
});
