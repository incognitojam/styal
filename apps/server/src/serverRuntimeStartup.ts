...
>()("@styal/cli/serverRuntimeStartup") {}
...
export const make = (options?: StartupOptions) =>
  Effect.gen(function* () {
    ...
    const initialWelcomePublished = yield* Deferred.make<void>();
    ...
    const startup = Effect.gen(function* () {
        ...
        yield* forkParked(
          runStartupPhase(
            ...
            Effect.gen(function* () {
              ...
              // Late subscribers must never replay pending after bootstrap has completed.
              yield* Deferred.await(initialWelcomePublished);
          ...
          if (serverConfig.startupPresentation === "headless") {
            ...
            if (serverConfig.mode !== "desktop") {
              yield* Effect.logInfo(
                "Authentication required. Open styal using the pairing URL.",
      ...
      yield* Deferred.succeed(initialWelcomePublished, undefined);
