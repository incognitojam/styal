...
function getGnomeKeyringRemediationMessage(): string {
  return "styal could not access GNOME Keyring to save this environment credential. Install and start GNOME Keyring, then restart styal.";
}

function getKWalletRemediationMessage(): string {
  return "styal could not access KWallet to save this environment credential. Enable the KDE wallet subsystem in System Settings, then restart styal.";
}
