...
## OpenAI outage alerts

When OpenAI's status page reports an incident affecting Codex or the OpenAI API
...
such as Sora or voice mode do not appear. Turn alerts off in
