  ...
  return (
    <div className="border-b border-border/60 pb-2 pt-1">
      <button
        ...
        className="group/turn-fold flex w-full cursor-pointer select-none items-center gap-1 rounded-md px-1 text-xs text-muted-foreground tabular-nums transition-colors hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-ring/70 motion-reduce:transition-none"
      >
...
function workEntryIconName(workEntry: TimelineWorkEntry): WorkEntryIconName {
  ...
  // Before the file-change test: viewing an image discovers a path, which
  // otherwise wins and stamps a read-only row with an edit pencil.
