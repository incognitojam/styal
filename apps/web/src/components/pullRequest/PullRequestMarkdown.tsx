 ...
 * recordings can use codecs Chromium cannot decode. Opening the host keeps its playback
 * and download fallbacks available without introducing another inline player.
 */
