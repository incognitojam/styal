// @effect-diagnostics nodeBuiltinImport:off globalTimers:off globalDate:off - This host-side fixture creates an isolated local styal environment.
...
export const SHOWCASE_PROJECT_ID = "styal";
...
const SHOWCASE_TERMINAL_PROMPT =
  "\u001b[1;32m→\u001b[0m \u001b[1;36mstyal\u001b[0m \u001b[1;34mgit:(\u001b[1;31mfeat/remote-command-center\u001b[1;34m)\u001b[0m \u001b[1;33m✗\u001b[0m ";
...
export const SHOWCASE_TERMINAL_BUFFER = [
  ...
  "  \u001b[32m→\u001b[0m  \u001b[2mProject:\u001b[0m  \u001b[1mstyal\u001b[0m \u001b[2m— ~/Code/styal\u001b[0m",
  "",
...
const PROJECT_FAVICONS = {
  styal: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="28 -10 407 470">
  <rect x="-4" y="-4" width="471" height="478" rx="96" fill="#00242c"/>
  <g transform="translate(0 450) scale(1 -1)"><path d="M435 138Q435 63 375.5 26.5Q316-10 221-10Q172-10 122.5.5Q73 11 28 34L46 160L146 149V93Q164 87 184 85.5Q204 84 214 84Q251 84 278 96Q305 108 305 132Q305 161 264 170Q223 179 169 188Q115 197 74 225Q33 253 33 320Q33 403 97.5 431.5Q162 460 231 460Q321 460 400 419L411 304L311 293L303 356Q270 367 232 367Q207 367 189.5 356.5Q172 346 172 324Q172 295 211.5 285.5Q251 276 303.5 267Q356 258 395.5 230.5Q435 203 435 138Z" fill="#fff"/></g>
</svg>`,
...
export const SHOWCASE_PROJECTS = [
  {
    ...
    title: "styal",
    directory: "styal",
    repositoryUrl: "https://github.com/incognitojam/styal.git",
    favicon: PROJECT_FAVICONS.styal,
  },
  {
    id: "react",
    title: "React",
...
async function seedStyalWorkspace(workspaceRoot: string): Promise<void> {
  ...
  await NodeFSP.writeFile(
    ...
    `${JSON.stringify({ name: "styal", private: true, scripts: { test: "vp test" } }, null, 2)}\n`,
  );
  await NodeFSP.writeFile(NodePath.join(workspaceRoot, "favicon.svg"), PROJECT_FAVICONS.styal);
  await NodeFSP.writeFile(
...
async function seedCompanionWorkspace(input: {
  ...
  await NodeFSP.writeFile(
    ...
    `# ${input.title}\n\nSeeded by the styal mobile screenshot harness.\n`,
  );
  await initializeRepository({
...
export async function seedShowcaseEnvironment(input: {
  ...
  if (primaryProject.id === SHOWCASE_PROJECT_ID) {
    await seedStyalWorkspace(workspaceRoot);
  }
  await Promise.all(
    projects
