...
- Reads the shared production styal Connect relay URL and Clerk client configuration before packaging clients.
...
## styal Connect relay deployment
...
10. Complete the Clerk Native API and AASA setup in [styal Connect Clerk Setup](../internals/t3-connect.md#desktop-passkeys).
