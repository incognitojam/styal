...
npm publication is immutable. A failure partway through publication needs an operator
to reconcile which exact versions exist before retrying; do not rerun a successful
publication blindly. GitHub release publication waits for CLI and desktop success.
