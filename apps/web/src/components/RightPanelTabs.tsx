...
const SURFACE_DISABLED_REASONS = {
  browser: "Browser previews are only available in the styal desktop app.",
          ...
          <div className="flex h-full w-max min-w-full items-center gap-1">
            ...
            {props.surfaces.length > 0 ? (
              <Menu
                ...
                onOpenChangeComplete={handleAddMenuOpenChangeComplete}
              >
                <MenuTrigger
                  render={
                    <Button
                  ...
                  {addSurfaceActions.map((action) => {
                    ...
                    return (
                      <SurfaceMenuItem
                        ...
                        onClick={() => addSurfaceFromMenu(action.onClick)}
                      >
                        <Icon />
                        {action.label}
                      </SurfaceMenuItem>
      ...
      >
        {props.activeSurfaceId === null ? (
          <RightPanelEmptyState
            ...
            onAddBrowserInProfile={(profileId) =>
              addSurfaceAndKeepFocus(() => props.onAddBrowserInProfile(profileId))
            }
