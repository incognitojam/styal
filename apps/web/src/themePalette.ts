...
/**
 * The palette styal wears with no theme installed, captured from the app's
...
/**
 * The standard styal look as a theme palette, for seeding a new theme when
...
/**
 * The status colors styal shows without a theme, read from the app's own
