    ...
    >
      ...
      <div className="relative h-full min-h-0">
        ...
        <button
          ...
          className="pointer-events-auto absolute bottom-0 right-0 z-[49] size-5 cursor-nwse-resize rounded-br-[14px] after:absolute after:bottom-1 after:right-1 after:size-2 after:border-b after:border-r after:border-foreground/45"
