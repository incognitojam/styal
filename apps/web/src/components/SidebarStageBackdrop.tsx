...
export type EnvironmentIdentificationPillLabel = "Dev" | "Nightly" | "Preview";
...
export function resolveSidebarStageBackdropVariant(
  ...
  // Pull request previews share the development artwork.
  if (normalized === "dev" || normalized === "preview") return "dev";
  return null;
}
