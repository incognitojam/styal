  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new styal prerelease is available for nightly testers."
          : "A new styal latest release is available.",
...
).pipe(Command.withDescription("Post a styal release announcement to Discord."));
