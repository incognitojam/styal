...
import { useFreshAttachmentUrlState } from "../state/assets";
...
function NativeVideoPreview(props: {
  ...
  const assetUrl = useFreshAttachmentUrlState(
    environmentId,
    source.type === "remote"
...
export function VideoPreviewModal(props: {
  ...
  return <NativeVideoPreview key={key} source={source} onRequestClose={props.onRequestClose} />;
}
